"""
Main Bot Runner for Delta Neutral Arbitrage.
...
from src.core.risk_engine import RiskEngine, ExitDecision, ExitReason
...
class DeltaNeutralBot:
    """
    Main bot for Delta Neutral Funding Rate Arbitrage.
