...
class AsgardClient:
    ...
    async def get_markets(self) -> dict:
        ...
        Returns dict with "strategies" (nested by name) and "totalStrategies".
        Each strategy has "liquiditySources" with per-protocol rates.

        See https://github.com/asgard-finance/api-docs for full schema.
        """
