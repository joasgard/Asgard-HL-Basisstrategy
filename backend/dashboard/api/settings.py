...
from backend.dashboard.auth import require_operator
...
class StrategySettings(BaseModel):
    ...
    stop_loss_percent: float = Field(10.0, ge=0, le=50)
    take_profit_percent: float = Field(50.0, ge=0, le=200)
...
async def save_settings(
    ...
    try:
        ...
        # Audit log
        await db.execute(
            "INSERT INTO audit_log (action, \"user\", details, success) VALUES ($1, $2, $3, $4)",
