...
from backend.dashboard.setup import SetupJobManager, SetupSteps, SetupValidator
from backend.dashboard.setup.jobs import JobType
from backend.dashboard.security import sanitize_for_audit, SecretSanitizer
...
async def configure_privy(
    ...
    if result["success"]:
        ...
        return {"success": True, "redirect": "/setup/privy/auth"}
...
async def finalize_setup(
    ...
    """
    from backend.dashboard.auth import get_current_session
